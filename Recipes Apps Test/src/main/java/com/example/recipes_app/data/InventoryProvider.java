...
public class InventoryProvider extends ContentProvider{
    ...
    static {
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_RECIPE, CODE_TABLE_ALL);
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_RECIPE+"/#", CODE_TABLE_ID);
    }
    @Override
    ...
    public Uri insert(Uri uri,ContentValues values){
        ...
        switch (match) {
            case CODE_TABLE_ALL:
                ...
                if (values.containsKey(Entry.COLUMN_RECIPE_NAME)) {
                    String name = values.getAsString(Entry.COLUMN_RECIPE_NAME);
